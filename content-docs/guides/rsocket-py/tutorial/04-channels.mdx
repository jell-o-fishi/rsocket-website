...
*Lines 6-11* define a [request-stream](https://rsocket.readthedocs.io/en/stable/api.html#rsocket.request_handler.RequestHandler.request_stream) endpoint for getting a list of channels. It uses the `StreamFromGenerator` helper. Note that the argument to this class
