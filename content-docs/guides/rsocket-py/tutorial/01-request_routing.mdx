...
*Lines 12-15* define the login method and attach it to a [request-response](https://rsocket.readthedocs.io/en/stable/api.html#rsocket.request_handler.RequestHandler.request_response) with the <b>login</b> route.
