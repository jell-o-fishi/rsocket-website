...
*Lines 14-16* defines an endpoint for receiving statistics from the client. It uses the [fire-and-forget](https://rsocket.readthedocs.io/en/latest/api.html#rsocket.request_handler.RequestHandler.request_fire_and_forget) request type, since this
...
*Lines 18-59* defines an endpoint for sending statistics to the client. It uses the [request-channel](https://rsocket.readthedocs.io/en/stable/api.html#rsocket.request_handler.RequestHandler.request_channel) request type, which will allow
